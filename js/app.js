	...
	let currentCourseName = '';
        ...
        function renderHomeDashboard(indexData) {
            ...
            readingCard.className = 'mode-card';
            readingCard.onclick = () => openReadingMenu();
            readingCard.innerHTML = `
                <div class="mode-icon" style="display:flex;align-items:center;justify-content:center;width:44px;height:44px;background:var(--accent-light);border-radius:12px;flex-shrink:0;">
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#2C3E6B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                </div>
                <div class="mode-info">
                    <div class="mode-title">Reading Practice</div>
                    <div class="mode-desc">A1 English texts with comprehension, translation, and fill-in-the-blank exercises.</div>
                </div>
            `;
